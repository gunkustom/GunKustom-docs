...
export default {
  ...
  "presets": [
    [
      ...
      {
        "docs": {
          "sidebarPath": "/home/menokoog/development/gunkustom/GunKustom-docs/sidebars.ts",
        ...
        "theme": {
          "customCss": "/home/menokoog/development/gunkustom/GunKustom-docs/src/css/custom.css"
        }
      }
    ]
  ],
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2024 GunKustom. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
